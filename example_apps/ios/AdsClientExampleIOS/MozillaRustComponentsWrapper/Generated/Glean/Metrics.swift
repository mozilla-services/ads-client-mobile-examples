...
extension GleanMetrics {
    class GleanBuild {
        ...
        public static let info = BuildInfo(buildDate: DateComponents(calendar: Calendar.current, timeZone: TimeZone(abbreviation: "UTC"), year: 2025, month: 9, day: 26, hour: 17, minute: 58, second: 54))
    }
